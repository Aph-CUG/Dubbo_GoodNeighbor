...
import com.an.interfaces.IOrderRpc;
import com.an.mq.MqProducer;
...
import static com.an.rpc.BaseRpc.CONTENT_TYPE_FORMED;

@DubboService
@Service
public class OrderRpcImpl extends BaseRpc implements IOrderRpc {
    @Autowired
